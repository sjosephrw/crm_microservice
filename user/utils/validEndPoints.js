...
//POST only endpoints
const postMethodEndPoints = ['/api/v1/auth/signup', '/api/v1/auth/signin', '/api/v1/document', '/api/v1/user',  '/api/v1/user/profile-img', '/api/v1/user/search', '/api/v1/events'];

//[GET, PATCH, DELETE] end points with query parameters '?id=123',
const getPatchDeleteEndPoints = [
    '/api/v1/document', '/api/v1/user', '/api/v1/user/modify-password', '/api/v1/user/modify-email'
]
